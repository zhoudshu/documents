...
![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_03.png)
...
![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_04.png)
...
![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_05.png)

3.  进入推流鉴权配置页，单击

![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_06.png) 按钮选择开启/关闭推流鉴权。

4. 修改 KEY ，单击【保存】即可成功生效。

![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_07.png)
...
2. 选择【推流配置】>【推流地址生成器】，进行如下配置：
  ...
  ![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_08.png)
...
2.	选择【模板配置】页签，单击【录制配置】标签右上角的【编辑】。
    ...
    ![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_09.png)

3. 选择录制配置模板，单击【保存】即可。

    ![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_10.png)
...
3. 单击取消相应模板的勾选，单击【保存】即可。
    ...
    ![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_12.png)
...
2. 选择【模板配置】，单击【截图配置】标签右上角的【编辑】。
    ...
    ![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_13.png)

3. 选择截图配置模板。单击【保存】即可完成配置。

    ![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_14.png)
...
3. 单击取消相应模板的勾选，单击【保存】即可。
 ...
 ![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_15.png)
...
![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_16.png)

4.	选择水印配置模板，单击【保存】即可。

    ![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_17.png)
...
3. 单击取消相应模板的勾选，单击【保存】即可。
    ...
    ![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_18.png)
...
4. 单击【保存】即可。
    ...
    ![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_19.png)
...
4. 然后单击【保存】，即可取消模板与域名的关联。
   ...
   ![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_20.png)
...
3.	选择指定对应的回调模板，单击【保存】即可。
    ...
    ![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_21.png)
...
3. 取消关联模板的勾选，单击【保存】即可。
    ...
    ![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_22.png)
...
2. 选择【播放配置】>【播放地址生成器】，进行如下配置：
    ...
    ![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_23.png)

3. 若您的播放域名未开启播放鉴权，您还可以在【播放配置】>【播放地址】标签下，查看该播放域名下 RTMP、FLV、HLS 这三种播放地址。替换播放地址中的 StreamName（流名称）关联推流地址，关联后即可通过播放地址查看直播画面。

    ![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_24.png)
...
> - **有效时间**：签名的有效时间，时间戳为十六进制 UNIX 时间。
  ...
  ![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_25.png)
...
![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_26.png)

![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_27.png)
...
![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_28.png)

## 启用域名
若您需要将已禁用的域名重新启用，单击所需启用的域名右侧【启用】，当该域名状态由“未启用”变为“已启用”，表示域名禁用成功。

![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_29.png)

## 删除域名
若您需要删除域名，单击目标域名右侧的【删除】，在弹窗中确认是否需要删除当前域名，单击【确定】后即可删除域名。

![](https://docs.zhoudsh.com:9443/images/cloudlive/cloudlive_30.png)
